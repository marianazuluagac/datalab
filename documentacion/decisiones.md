...
No fue necesario realizar ajustes en el esquema actual, ya que las tablas se encuentran organizadas de acuerdo con las entidades y relaciones del proyecto.

### Actualización del esquema

Durante la Semana 4 se actualizaron las relaciones del modelo para definir las políticas de integridad referencial mediante `ON DELETE`.

También se actualizó el diagrama relacional y se generó la evidencia:

`diagramas/relacional/s04-esquema-integridad.png`

Las decisiones de integridad referencial y normalización quedaron documentadas en este archivo.